...
public class CameraTakePictureConfig implements Serializable{
    ...
    public CameraTakePictureConfig(Bulid bulid, Context context) {
    ...
    public static class Bulid{
        ...
        public CameraTakePictureConfig build(Context context){
            return new CameraTakePictureConfig(this,context);
        }
